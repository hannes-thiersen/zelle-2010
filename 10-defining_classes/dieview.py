...
class DieView():
    ...
    def __init__(self, win, center, size):
        ...
        self.value = 1              # set the initial value to 1
    ...
    def setValue(self, value=None):
        ...
        # store the value if given otherwise use existing one
        if value:
            self.value = value
        else:
            value = self.value
    ...
    def setColor(self, color):
        """Set the color of the pips."""
        self.foreground = color     # change the color
        self.setValue(self.value)   # redraw the pips of the dice
